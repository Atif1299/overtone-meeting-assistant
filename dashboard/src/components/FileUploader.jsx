  ...
  return (
    ...
    >
      ...
      <p className="helper-text">
        Each slide is rendered as an image and analyzed by Gemini Vision for semantic search.
      </p>
      <input
        className="input"
        type="file"
      ...
      {busy ? <p className="helper-text shimmer-text">Uploading — Gemini Vision is processing each slide...</p> : null}
    </div>
  );
}
