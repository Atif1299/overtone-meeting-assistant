...
export default function OvertoneMark({ tone = "light", size = 28, className = "", decorative = false }) {
  ...
  return (
    <svg
      ...
      aria-label={decorative ? undefined : "Overtone"}
    >
      {decorative ? null : <title>Overtone</title>}
