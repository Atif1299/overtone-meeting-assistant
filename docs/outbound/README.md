# Partner outbound pack — Drew Harris

Attach all three PDFs to one email (order matters).

| # | File | Role |
|---|------|------|
| 1 | `01_Overtone_Follow_Up_Letter.pdf` | Cover letter |
...
```powershell
python docs/outbound/generate_partner_pdfs.py
```
