...
const personas = [
  { icon: "◆", title: "Sales & solutions", body: "Run repeatable product demos without pulling senior engineers into every call. Stay on-deck when prospects go off-script.", image: "/assets/bot-meeting.svg" },
  { icon: "▲", title: "Founders & fundraising", body: "Pitch investors with a consistent narrative. Answer diligence questions from the actual slide — not from memory.", image: "/assets/slide-navigation.svg" },
  { icon: "◉", title: "Customer success", body: "Onboard accounts with the same playbook deck. Scale walkthroughs without scheduling conflicts.", image: "/assets/use-cases.svg" },
];
