...
/** Microsoft Teams is no longer exported by simple-icons; path + hex from simple-icons 11. */
...
/** Official Recall.ai mark is the circle from their wordmark (no plate). */
const siRecall = {
  title: "Recall.ai",
  hex: "2D7DF6",
  path: "M12 0a12 12 0 1 0 0 24 12 12 0 0 0 0-24z",
};
